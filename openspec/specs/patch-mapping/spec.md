...
Define the PatchMap abstraction, IPatchApplier service, source-generated dispatch, DI registration, and related diagnostics for applying patch documents to target entities.
