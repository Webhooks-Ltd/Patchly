# deterministic-patch-semantics Specification

## Purpose
Define optional deterministic tri-state PATCH semantics so consumers can reliably distinguish omitted, null, and value states across scalar, nested, and collection properties.
## Requirements
